...
RSpec.describe 'Strava::Api::Client#athlete_stats' do
  let(:client) { Strava::Api::Client.new(access_token: ENV['STRAVA_ACCESS_TOKEN'] || 'access-token') }
  describe '#athlete_stats', vcr: { cassette_name: 'client/athlete_stats' } do
    let(:athlete_stats) { client.athlete_stats(id: 26_462_176) }
