...
RSpec.describe 'Strava::Api::Client#segment_effort', vcr: { cassette_name: 'client/segment_effort' } do
  ...
  it 'returns a segment effort' do
    ...
    expect(segment_effort.distance).to eq 419.58
    expect(segment_effort.distance_s).to eq '0.42km'
    ...
    expect(segment_stats).to be_a Strava::Models::SummaryPRSegmentEffort
    ...
    expect(segment_stats.effort_count).to eq 5
  end
