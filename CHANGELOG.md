...
* [#77](https://github.com/dblock/strava-ruby-client/pull/77): Drops supported endpoint/method to retrieve photos explicitly - [@simonneutert](https://github.com/simonneutert).
